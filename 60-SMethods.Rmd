...
ds = data.frame(x = c('Disease A','Not Disease A'),
                ...
                `Total` = c('Ta','Tna'))
kable(ds, format = "latex", booktabs = T,  caption = 'Contingency table for disease comorbidities.', longtable=T) %>%
